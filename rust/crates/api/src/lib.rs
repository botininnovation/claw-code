...
pub use providers::openai_compat::{
    ...
    flatten_tool_result_content, interleaved_reasoning_field_for_model, is_reasoning_model,
...
pub use providers::{
    ...
    resolve_model_alias, InterleavedReasoningField, ProviderDiagnostics, ProviderKind,
};
